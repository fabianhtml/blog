...
Puedes correrlo en tu computador para proyectos personales. Pero si necesitas alta disponibilidad, lo mejor es montarlo en un servidor (VPS). Yo [aprendí eso por las malas](/posts/bot-entrevistas-ia/) cuando un camión cortó un cable y mi bot de entrevistas se cayó por horas.
...
El [bot de entrevistas](/posts/bot-entrevistas-ia/) que mencioné guarda nombres, teléfonos, información de negocios. Si alguien compromete el servidor, expongo datos que no son míos. De gente que confió en el sistema.
